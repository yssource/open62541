...
""".format(prefix=generate_ids_prefix))
    ...
    for nid in nodes_filtered:
        ...
        name = node.symbolicName.value if node.symbolicName is not None else node.browseName.name
        n1 = node
        ...
        while n1 is not None:
            ...
            n1 = parent
            name2 = parent.symbolicName.value if parent.symbolicName is not None else parent.browseName.name
            name = name2 + "_" + name
